...
BEGIN_MESSAGE_MAP(CMFCNETApp, CWinApp)
...
BOOL CMFCNETApp::InitInstance()
{
	...
	GetModuleFileName(m_hInstance, g_szModulePath, sizeof(g_szModulePath));
	_tsplitpath_s(g_szModulePath, drive, dir, fname, ext);
	wsprintf(g_szModulePath, _T("%s%s"), drive, dir);
